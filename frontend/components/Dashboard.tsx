...
This assessment aligns with Basel III operational risk management requirements and AML/CFT regulatory standards. Documentation retained per regulatory retention policies.`,
  ...
  return (
    <div className="min-h-screen bg-bg-primary dot-grid relative flex flex-col">
      <Toaster 
        position="top-right"
        toastOptions={{
          style: {
        ...
        <div className="container mx-auto px-6 py-6">
          <div className="flex flex-col sm:flex-row items-center justify-between">
            <div className="flex items-center space-x-2 mb-4 sm:mb-0">
              ...
              <span className="text-sm font-semibold text-text-primary">Achintya Gupta</span>
            </div>
            ...
            <div className="flex items-center space-x-6">
              <a
                ...
                className="flex items-center space-x-2 text-text-secondary hover:text-accent-blue transition-colors duration-200 group"
              >
