...
export const metadata: Metadata = {
  title: 'FraudGuard AI - Advanced Fraud Detection Dashboard',
  ...
  return (
    <html lang="en">
      <body className={`${inter.className} bg-background text-white min-h-screen flex flex-col`}>
        ...
        <footer style={{ background: '#0d0d0d', borderTop: '1px solid #1e1e1e' }}>
          <div style={{ maxWidth: '1200px', margin: '0 auto', padding: '20px 24px', display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
            <span style={{ fontSize: '13px', color: '#555' }}>
              Built by <span style={{ color: '#888', fontWeight: 600 }}>Achintya Gupta</span>
            </span>
            <div style={{ display: 'flex', alignItems: 'center', gap: '24px' }}>
              <a
                ...
                style={{ display: 'flex', alignItems: 'center', gap: '7px', color: '#555', textDecoration: 'none', fontSize: '13px', transition: 'color 0.2s' }}
